        ...
        r = (function () {
          function e(e) {
            ...
            i.dataset.ssid && this.destroy(i.dataset.ssid),
              ...
              (this.data = new l.Data({ main: this })),
        ...
        n = (function () {
          ...
          return (
              ...
              return (
                ...
                (i.onclick = function (e) {
                  ...
                  if (l.main.config.isEnabled) {
                    if (
                      (l.main.beforeOnChange || (t = !0), l.main.beforeOnChange)
                    ) {
                      for (
                        var i = l.main.data.getSelected(),
                          n = JSON.parse(JSON.stringify(i)),
                          s = 0;
                        s < n.length;
                        s++
                      )
                        n[s].id === a.id && n.splice(s, 1);
                      !1 !== l.main.beforeOnChange(n) && (t = !0);
                    }
                    t &&
                      (l.main.data.removeFromSelected(a.id, "id"),
                      l.main.render(),
                      l.main.select.setValue(),
                      l.main.data.onDataChange());
                  }
                }),
                e.appendChild(i),
                e
            ...
            (e.prototype.searchDiv = function () {
              ...
              var t = { container: e, input: n };
              return (
                this.main.config.showSearch ||
                  (e.classList.add(this.main.config.hide), (n.readOnly = !0)),
                (n.type = "search"),
                ...
                (n.onkeydown = function (e) {
                  "ArrowUp" === e.key
                    ? (s.main.open(), s.highlightUp(), e.preventDefault())
                    : "ArrowDown" === e.key
                      ? (s.main.open(), s.highlightDown(), e.preventDefault())
                      : "Tab" === e.key
                        ? s.main.close()
                ...
                (n.onkeyup = function (e) {
                  ...
                  if ("Enter" === e.key) {
                    ...
                    var i = s.list.querySelector(
                      "." + s.main.config.highlighted,
                    );
                    i && i.click();
                  } else
                    "ArrowUp" === e.key ||
                      ...
                      ("Escape" === e.key
                        ? s.main.close()
                        : s.main.config.showSearch && s.main.data.contentOpen
                          ? s.main.search(t.value)
                          : (n.value = ""));
                  e.preventDefault(), e.stopPropagation();
                }),
                (n.onfocus = function () {
                ...
                this.main.addable &&
                  ...
                  (a.onclick = function (e) {
                    if (s.main.addable) {
                      ...
                      if ("object" == typeof i)
                        o.validateOption(i) &&
                          (s.main.addData(i), (n = i.value ? i.value : i.text));
                      else
                        s.main.addData(
                          s.main.data.newOption({ text: i, value: i }),
                        ),
                          (n = i);
                      s.main.search(""),
                        setTimeout(function () {
            ...
            (e.prototype.highlightUp = function () {
              ...
              if (
                ...
                if (
                  ...
                  var s = n.previousSibling.querySelectorAll(
                    "." +
                      this.main.config.option +
                      ":not(." +
                      this.main.config.disabled +
              ...
              t &&
                ...
                l.ensureElementInView(this.list, t));
            }),
                        ...
                        if (
                          ...
                          i.addEventListener("click", function (e) {
                            ...
                            for (var t = 0, i = s.children; t < i.length; t++) {
                              var n = i[t];
                              -1 !==
                                n.className.indexOf(r.main.config.option) &&
                                n.click();
                            }
                          });
                        }
                ...
                i.addEventListener("click", function (e) {
                  if (
                    ...
                    if (a.main.beforeOnChange) {
                      var i = void 0,
                        n = JSON.parse(
                          JSON.stringify(a.main.data.getObjectFromData(t)),
                        );
                      (n.selected = !0),
                        a.main.config.isMultiple
                          ? (i = JSON.parse(JSON.stringify(s))).push(n)
                          : (i = JSON.parse(JSON.stringify(n))),
                        !1 !== a.main.beforeOnChange(i) &&
                          a.main.set(t, "id", a.main.config.closeOnSelect);
                    } else a.main.set(t, "id", a.main.config.closeOnSelect);
                  }
                }),
                (e.disabled ||
                  (s && l.isValueInArrayOfObjects(s, "id", e.id))) &&
                  ((i.onclick = null),
