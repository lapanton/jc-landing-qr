    ...
    <Wrapper>
      {(pathname.includes('/letter') || pathname.includes('/qr/')) ?
        ...
        <>
          ...
          <p className="textThree">{langProps.locale === "ru" ? "Этот код ведет на цифровое послание любого типа – открытка, поздравление, изображение, видеоролик, признание в любви, фотография, любой формат пожеланий в цифровом виде. Это уникальная возможность сделать подарок с личным посланием и смыслом, сохранить важные и дорогие сердцу моменты или передать свои признания и эмоции близким на собственном украшении с душой." : "This code leads to a digital message of any type - a postcard, greeting, image, video clip, love confession, photograph, any format of wishes in digital form. This is a unique opportunity to make a gift with a personal message and meaning, to preserve important and dear-to-heart moments or to convey your acknowledgments and emotions to your loved ones on your own piece of jewelry with soul."}</p>
        </>
      }
    </Wrapper>
  );
