    ...
    <Wrapper>
      <Inner>
        <div className="slider-wrap">
          ...
          <h4>men`s<br/> talisman-bracelet</h4>}
        ...
        <ChooseStone>
          ...
          <p className="description">
            { dorsStone === '1d-t' && (langProps.locale === "ru" ? "Агат — источник доброй энергии" : "Jasper is a variety of Chalcedony")}
            { dorsStone === '2d-t' && (langProps.locale === "ru" ? "Яшма - приносит здоровье, счастье и долголетие": "Agate has a stable and grounding quality")}
            ...
            { dorsStone === '5d-t' && (langProps.locale === "ru" ? "Пирит — источник доброй энергии" : "Pyrite is an iron sulfide mineral with a metallic luster")}
            ...
            { dorsStone === '8d-t' && (langProps.locale === "ru" ? "Оникс является мощным поглотителем энерги." : "Onyx is a stone that offers up powerful vibrations of protection")}
        ...
        <DescriptionProduct>
          ...
          {showDescr && (
            <DescriptionView>
              <p className="slave-text">{langProps.locale === "ru" ? "Браслет-талисман Jewel Cocktail в стиле минимализм. Со сменными вставками из натуральных материалов. Особенная вставка с QR ссылкой на персональный талисман." : "Jewel Cocktail talisman-bracelet in minimalist style with replaceable natural stones. Special stone with QR link to your personal talisman"}</p>
              <p className="main-text">
                <FormattedMessage id="shop.complectation" />:
              </p>
              <p className="slave-text">
                {langProps.locale === "ru" ? "Браслет, вставка с QR, фирменная коробка": "pendant, engraved QR stone , branded box"}
              </p>
              <p className="main-text">
