...
export const KeyHolderTalisman = (props) => {
  ...
  const [keyStone, setKeyStone] = useState("1k-t");
  ...
  const settingsStones = {
    ...
    beforeChange: (current, next) => {
      setKeyStone(`${next + 1}k-t`);
    },
  };
  const buyDors = () => {
    const arr1 = [
      {
        product: "keyHolderTalisman",
        stone: keyStone,
        price: +priceData["talisman-keyhoder"],
      },
    ];
    const checkedItem = card.filter(
      (value) => value.product !== "keyHolderTalisman",
    );
    ...
    <Wrapper>
      <Inner>
        <div className="slider-wrap">
          {langProps.locale === "ru" ? (
            <h4>БРЕЛОК-ТАЛИСМАН</h4>
          ) : (
            <h4>KEY HOLDER-TALISMAN</h4>
          )}
          <Slider
            {...settings}
            asNavFor={nav2}
          ...
          >
            ...
            <div>
              <img src={nine} alt="JewelCocktail" onClick={() => openZoom(9)} />
            </div>
            <div>
              <img src={ten} alt="JewelCocktail" onClick={() => openZoom(10)} />
            </div>
            <div>
              <img
                src={eleven}
          ...
          {showDescr && (
            <DescriptionView>
              <p className="slave-text">
                {langProps.locale === "ru"
                  ? "БРЕЛОК-ТАЛИСМАН Jewel Cocktail в стиле минимализм. Со сменными вставками из натуральных материалов. Особенная вставка с QR ссылкой на персональный талисман."
                  : "Designer KEY HOLDER-TALISMAN in minimalist style for every day with interchangeable inserts (stones)"}
              </p>
              ...
              <p className="slave-text">
                {langProps.locale === "ru"
                  ? "БРЕЛОК-ТАЛИСМАН, вставка с QR, фирменная коробка"
                  : "KEY HOLDER-TALISMAN, engraved QR stone , branded box"}
              </p>
              <p className="main-text">
