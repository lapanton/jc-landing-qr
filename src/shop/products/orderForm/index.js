            ...
            <>
              ...
              {item.product === "pendantTalisman" ?
                <div key={index}>
                  ...
                  { item.stone === '1p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Змеевик — поглотитель негативной энергии и защитник." : "Serpentine it is a mineral that is also called like Lizardite, Infinite or Healerite."} /></>}
                  { item.stone === '2p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Агат - приносит здоровье, счастье и долголетие." : "Agate has a stable and grounding quality."} /></>}
                  { item.stone === '3p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Яшма — источник доброй энергии." : "Jasper is a variety of Chalcedony."} /></>}
                  { item.stone === '4p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Говлит - официально был описан только в конце XIX века" : "Howlight is also called like Snow Leopard Stone or as magnesite."} /></>}
                  { item.stone === '5p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Обсидиан - является мощным поглотителем энергии и хранителем информации." : "Obsidian is truth-enhancing. A strongly protective stone"} /></>}
                  { item.stone === '6p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Пирит - укрепляющет нервную систему" : "Pyrite is an iron sulfide mineral with a metallic luster"} /></>}
                  { item.stone === '7p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Тигровый глаз — камень мудрецов и правителей." : "Tiger eye is a variety of Chalcedony, a cryptocrystalline form of silica"} /></>}
                  { item.stone === '8p-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Натуральный жемчуг — кладезь ценных микроэлементов." : "Natural pearls have long been a source of pure fascination"} /></>}
              ...
              {item.product === "ringTalisman" ?
                <div key={index}>
                  ...
                  { item.stone === '1r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Змеевик — поглотитель негативной энергии и защитник" : "Serpentine it is a mineral that is also called like Lizardite, Infinite or Healerite"} /></>}
                  { item.stone === '2r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Агат - приносит здоровье, счастье и долголетие" : "Agate has a stable and grounding quality"} /></>}
                  { item.stone === '3r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Яшма — источник доброй энергии" : "Jasper is a variety of Chalcedony"} /></>}
                  { item.stone === '4r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Говлит - официально был описан только в конце XIX века" : "Howlight is also called like Snow Leopard Stone or as magnesite"} /></>}
                  { item.stone === '5r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Обсидиан - является мощным поглотителем энергии и хранителем информации" : "Obsidian is truth-enhancing. A strongly protective stone"} /></>}
                  { item.stone === '6r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Пирит - укрепляющет нервную систему" : "Pyrite is an iron sulfide mineral with a metallic luster"} /></>}
                  { item.stone === '7r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Тигровый глаз — камень мудрецов и правителей" : "Tiger eye is a variety of Chalcedony, a cryptocrystalline form of silica"} /></>}
                  { item.stone === '8r-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Натуральный жемчуг — кладезь ценных микроэлементов" : "Natural pearls have long been a source of pure fascination"} /></>}
              ...
              {item.product === "alcorTalisman" ?
                <div key={index}>
                  ...
                  { item.stone === '1a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Змеевик — поглотитель негативной энергии и защитник" : "Serpentine it is a mineral that is also called like Lizardite, Infinite or Healerite"} /></>}
                  { item.stone === '2a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Агат - приносит здоровье, счастье и долголетие" : "Agate has a stable and grounding quality"} /></>}
                  { item.stone === '3a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Яшма — источник доброй энергии" : "Jasper is a variety of Chalcedony"} /></>}
                  { item.stone === '4a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Говлит - официально был описан только в конце XIX века" : "Howlight is also called like Snow Leopard Stone or as magnesite"} /></>}
                  { item.stone === '5a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Обсидиан - является мощным поглотителем энергии и хранителем информации" : "Obsidian is truth-enhancing. A strongly protective stone"} /></>}
                  { item.stone === '6a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Пирит - укрепляющет нервную систему" : "Pyrite is an iron sulfide mineral with a metallic luster"} /></>}
                  { item.stone === '7a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Тигровый глаз — камень мудрецов и правителей" : "Tiger eye is a variety of Chalcedony, a cryptocrystalline form of silica"} /></>}
                  { item.stone === '8a-t' &&  <><input type="hidden" name="pendantTalisman_stone" value={langProps.locale === "ru" ? "Натуральный жемчуг — кладезь ценных микроэлементов" : "Natural pearls have long been a source of pure fascination"} /></>}
