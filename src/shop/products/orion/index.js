    ...
    <Wrapper>
      <Inner>
        ...
        <ChooseStone>
          ...
          <WrapStone>
            <div
              onClick={() => setOrionStone("1o")}
              className={orionStone === "1o" ? "active" : "not"}
            >
              <img src={oneStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setOrionStone("2o")}
              className={orionStone === "2o" ? "active" : "not"}
            >
              <img src={twoStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setOrionStone("3o")}
              className={orionStone === "3o" ? "active" : "not"}
            >
              <img src={threeStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setOrionStone("4o")}
              className={orionStone === "4o" ? "active" : "not"}
            >
              <img src={fourStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setOrionStone("5o")}
              className={orionStone === "5o" ? "active" : "not"}
            >
