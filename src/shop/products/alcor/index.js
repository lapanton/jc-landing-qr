    ...
    <Wrapper>
      <Inner>
        ...
        <ChooseStone>
          ...
          <WrapStone>
            <div
              onClick={() => setAlcorStone("1a")}
              className={alcorStone === "1a" ? "active" : "not"}
            >
              <img src={oneStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setAlcorStone("2a")}
              className={alcorStone === "2a" ? "active" : "not"}
            >
              <img src={twoStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setAlcorStone("3a")}
              className={alcorStone === "3a" ? "active" : "not"}
            >
              <img src={threeStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setAlcorStone("4a")}
              className={alcorStone === "4a" ? "active" : "not"}
            >
              <img src={fourStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setAlcorStone("5a")}
              className={alcorStone === "5a" ? "active" : "not"}
            >
