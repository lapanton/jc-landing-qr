    ...
    <Wrapper>
      <Inner>
        ...
        <ChooseStone>
          ...
          <WrapStone>
            <div
              onClick={() => setDorsStone("1d")}
              className={dorsStone === "1d" ? "active" : "not"}
            >
              <img src={oneStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setDorsStone("2d")}
              className={dorsStone === "2d" ? "active" : "not"}
            >
              <img src={twoStone} alt="JewelCocktail" />
            </div>
            <div
              onClick={() => setDorsStone("3d")}
              className={dorsStone === "3d" ? "active" : "not"}
            >
            ...
            <div
              ...
              className={dorsStone === "5d" ? "active" : "not"}
            >
